...
static const char * FONTS_STR[]            = { "Auto", "VGA 8x8", "VGA 8x16"};
static const ufabgl::FontInfo * FONTS_INFO[] = { nullptr,  &ufabgl::FONT_8x8,  &ufabgl::FONT_8x16 };
...
struct ConfDialogApp : public uiApp {
  ...
  void init() {
    ...
    frameRect = frame->rect(ufabgl::uiOrigin::Screen);
    ...
    // little help
    new uiStaticLabel(frame, "uFabGL Terminal - (c) 2019-2022 by Fabrizio Di Vittorio - fabgl.com", Point(30, y), true, STYLE_LABELHELP2);
  ...
  static void setupDisplay() {
    ...
    switch (RESOLUTIONS_CONTROLLER[res]) {
      case ResolutionController::VGAController:
        DisplayController = new ufabgl::VGAController;
        break;
      case ResolutionController::VGA16Controller:
        DisplayController = new ufabgl::VGA16Controller;
        break;
      case ResolutionController::VGA2Controller:
        DisplayController = new ufabgl::VGA2Controller;
        break;
      case ResolutionController::VGA4Controller:
        DisplayController = new ufabgl::VGA4Controller;
        break;
      case ResolutionController::VGA8Controller:
        DisplayController = new ufabgl::VGA8Controller;
        break;
    }
    ...
    if (getFontIndex() == 0) {
      ...
      Terminal.loadFont(ufabgl::getPresetFontInfo(Terminal.canvas()->getWidth(), Terminal.canvas()->getHeight(), (cols ? cols : 80), (rows ? rows : 25)));
    } else {
      // load specified font
