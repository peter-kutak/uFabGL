  ...
  void setStyle(uiObject * object, uint32_t styleClassID) {
    switch (styleClassID) {
      case STYLE_FRAME:
        ...
        break;
      case STYLE_LABEL:
        ((uiLabel*)object)->labelStyle().textFont                   = &ufabgl::FONT_std_12;
      ...
      case STYLE_STATICLABEL:
        ((uiStaticLabel*)object)->labelStyle().textFont             = &ufabgl::FONT_std_12;
      ...
      case STYLE_LABELHELP:
        ((uiStaticLabel*)object)->labelStyle().textFont             = &ufabgl::FONT_std_14;
        ((uiStaticLabel*)object)->labelStyle().backgroundColor      = BACKGROUND_COLOR;
      ...
      case STYLE_LABELBUTTON:
        ((uiLabel*)object)->labelStyle().textFont                   = &ufabgl::FONT_std_14;
