...
/* Sk LAYOUT                                                                          */
/**************************************************************************************/
const KeyboardLayout SlovakLayout {
  // name
  "SK",
  ...
  //  in_key, { CTRL, LALT, RALT, SHIFT }, out_key
  {
    { VK_SEMICOLON,    { 0, 0, 0, 1 }, VK_DEGREE },       // SHIFT ";" = "°"
    { VK_PLUS,         { 0, 0, 0, 1 }, VK_1 },            // SHIFT "+" = "1"
    { VK_PLUS,         { 0, 0, 1, 0 }, VK_TILDE },        // AltGr "+" = "~"
    { VK_CARON_l,      { 0, 0, 0, 1 }, VK_2 },            // SHIFT "l" = "2"
    { VK_CARON_s,      { 0, 0, 0, 1 }, VK_3 },            // SHIFT "s" = "3"
    { VK_CARON_c,      { 0, 0, 0, 1 }, VK_4 },            // SHIFT "c" = "4"
    { VK_CARON_t,      { 0, 0, 0, 1 }, VK_5 },            // SHIFT "t" = "5"
    { VK_CARON_z,      { 0, 0, 0, 1 }, VK_6 },            // SHIFT "z" = "6"
    { VK_ACUTE_y,      { 0, 0, 0, 1 }, VK_7 },            // SHIFT "y" = "7"
    { VK_ACUTE_a,      { 0, 0, 0, 1 }, VK_8 },            // SHIFT "a" = "8"
    { VK_ACUTE_i,      { 0, 0, 0, 1 }, VK_9 },            // SHIFT "i" = "9"
    { VK_ACUTE_e,      { 0, 0, 0, 1 }, VK_0 },            // SHIFT "e" = "0"

    { VK_q,            { 0, 0, 1, 0 }, VK_BACKSLASH },    // AltGr "q" = "\"
    { VK_w,            { 0, 0, 1, 0 }, VK_VERTICALBAR },  // AltGr "w" = "|"
    { VK_e,            { 0, 0, 1, 0 }, VK_EURO },         // AltGr "e" = "€"
    { VK_s,            { 0, 0, 1, 0 }, VK_eth },          // AltGr "s" = "đ"
    { VK_d,            { 0, 0, 1, 0 }, VK_ETH },          // AltGr "d" = "Đ"
    { VK_f,            { 0, 0, 1, 0 }, VK_LEFTBRACKET },  // AltGr "f" = "["
    { VK_g,            { 0, 0, 1, 0 }, VK_RIGHTBRACKET }, // AltGr "g" = "]"
    { VK_k,            { 0, 0, 1, 0 }, VK_lstrok },       // AltGr "k" = "ł"
    { VK_l,            { 0, 0, 1, 0 }, VK_LSTROK },       // AltGr "l" = "Ł"
    { VK_AMPERSAND,    { 0, 0, 0, 1 }, VK_ASTERISK },     // SHIFT "&" = "*"
    { VK_AMPERSAND,    { 0, 0, 1, 0 }, VK_LESS },         // AltGr "&" = "<"
    { VK_y,            { 0, 0, 1, 0 }, VK_GREATER },      // AltGr "y" = ">"
    { VK_x,            { 0, 0, 1, 0 }, VK_HASH },         // AltGr "x" = "#"
    { VK_c,            { 0, 0, 1, 0 }, VK_AMPERSAND },    // AltGr "c" = "&"
    { VK_v,            { 0, 0, 1, 0 }, VK_AT },           // AltGr "v" = "@"
    { VK_b,            { 0, 0, 1, 0 }, VK_LEFTBRACE },    // AltGr "b" = "{"
    { VK_n,            { 0, 0, 1, 0 }, VK_RIGHTBRACE },   // AltGr "n" = "}"
    { VK_m,            { 0, 0, 1, 0 }, VK_MU },           // AltGr "m" = ""

    { VK_MINUS,        { 0, 0, 0, 1 }, VK_UNDERSCORE },   // SHIFT "-" = "_"
    { VK_EQUALS,       { 0, 0, 0, 1 }, VK_PERCENT },      // SHIFT "=" = "%"
    { VK_EQUALS,       { 0, 0, 1, 0 }, VK_DIAERESIS },    // AltGr "=" = ""
    { VK_ACUTEACCENT,  { 0, 0, 0, 1 }, VK_CARONACCENT },  // SHIFT "'" = "ˇ"
    { VK_UMLAUT_a,     { 0, 0, 0, 1 }, VK_LEFTPAREN },    // SHIFT "a" = "("
    { VK_CARET_o,      { 0, 0, 0, 1 }, VK_QUOTEDBL },     // SHIFT "ô" = """
    { VK_CARET_o,      { 0, 0, 1, 0 }, VK_DOLLAR },       // AltGr "ô" = "$"
    { VK_SECTION,      { 0, 0, 0, 1 }, VK_EXCLAIM },      // SHIFT "§" = "!"
    { VK_SECTION,      { 0, 0, 1, 0 }, VK_ESZETT },       // AltGr "§" = ""
    { VK_CARON_n,      { 0, 0, 0, 1 }, VK_RIGHTPAREN },   // SHIFT "n" = ")"
    { VK_CARON_n,      { 0, 0, 1, 0 }, VK_CURRENCY },     // AltGr "n" = ""
    { VK_COMMA,        { 0, 0, 0, 1 }, VK_QUESTION },     // SHIFT "," = "?"
    { VK_PERIOD,       { 0, 0, 0, 1 }, VK_COLON },        // SHIFT "." = ":"
    { VK_BACKSLASH,    { 0, 0, 0, 1 }, VK_VERTICALBAR },  // SHIFT "\" = "|"
  ...
  // deadkeys translation
  {
    ...
    { VK_CARONACCENT, VK_a, VK_CARON_a },
    { VK_CARONACCENT, VK_e, VK_CARON_e },
    { VK_CARONACCENT, VK_i, VK_CARON_i },
    { VK_CARONACCENT, VK_o, VK_CARON_o },
    { VK_CARONACCENT, VK_u, VK_CARON_u },
    { VK_CARONACCENT, VK_y, VK_CARON_y },
    { VK_CARONACCENT, VK_r, VK_CARON_r },
    { VK_CARONACCENT, VK_t, VK_CARON_t },
    { VK_CARONACCENT, VK_z, VK_CARON_z },
    { VK_CARONACCENT, VK_s, VK_CARON_s },
    { VK_CARONACCENT, VK_d, VK_CARON_d },
    { VK_CARONACCENT, VK_l, VK_CARON_l },
    { VK_CARONACCENT, VK_c, VK_CARON_c },
    { VK_CARONACCENT, VK_n, VK_CARON_n },
    ...
    { VK_CARETACCENT, VK_o, VK_CARET_o },
    { VK_CARETACCENT, VK_O, VK_CARET_O },

    { VK_RINGACCENT, VK_u, VK_RING_u },
    { VK_RINGACCENT, VK_U, VK_RING_U },
  },
};
