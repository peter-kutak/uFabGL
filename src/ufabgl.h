...
using ufabgl::Color;
using ufabgl::VGAScanStart;
using ufabgl::GlyphOptions;
using ufabgl::Scene;
using ufabgl::Bitmap;
using ufabgl::Sprite;
using ufabgl::CollisionDetector;
using ufabgl::Point;
using ufabgl::Size;
using ufabgl::Rect;
using ufabgl::MouseDelta;
using ufabgl::MouseStatus;
using ufabgl::CursorName;
using ufabgl::SoundGenerator;
using ufabgl::SoundGenMethod;
using ufabgl::SineWaveformGenerator;
using ufabgl::SquareWaveformGenerator;
using ufabgl::NoiseWaveformGenerator;
using ufabgl::VICNoiseGenerator;
using ufabgl::TriangleWaveformGenerator;
using ufabgl::SawtoothWaveformGenerator;
using ufabgl::SamplesGenerator;
using ufabgl::WaveformGenerator;
using ufabgl::TermType;
using ufabgl::SupportedTerminals;
using ufabgl::PS2Preset;
using ufabgl::PS2DeviceType;
using ufabgl::KbdMode;
using ufabgl::VirtualKey;
using ufabgl::VirtualKeyItem;
using ufabgl::FileBrowser;
using ufabgl::ModalWindowState;
using ufabgl::Canvas;
using ufabgl::PixelFormat;
using ufabgl::RGB222;
using ufabgl::RGBA2222;
using ufabgl::RGB888;
using ufabgl::RGBA8888;
using ufabgl::FlowControl;
using ufabgl::LineEditorSpecialChar;
using ufabgl::LineEditor;
using ufabgl::TerminalController;
using ufabgl::LineEnds;
using ufabgl::CharStyle;
using ufabgl::TerminalTransition;
using ufabgl::SupportedLayouts;
using ufabgl::CoreUsage;
using ufabgl::InputResult;
using ufabgl::InputBox;
